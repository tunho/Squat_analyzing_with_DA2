...
def main():
    print("=== Processing FULL DATASET with KNEE ANGLE LOGIC ===")
    
    dataset_base = "/home/lee/exe_est/dataset"
    output_base = "/home/lee/exe_est/dataset_results/knee" # Separate folder
    
    # Subfolders
    categories = ["true", "false"]
    
    # Initialize Analyzer (Knee Version)
    ...
    # Save Summary CSV
    csv_path = os.path.join(output_base, "dataset_summary_knee.csv")
